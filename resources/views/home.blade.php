        ...
        <div class="carousel-inner" style="min-height:fit-content;">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                    {{-- <h1 class="animate__fadeInLeft" style="animation-duration: 1s;">Student</h1>
                    <h2 class="animate__fadeInLeft" style="animation-duration: 3s;">Lorem ipsum dolor sit amet !</h2> --}}

                    {{-- <button type="button" class="btn btn-success animate__fadeInUpBig" style="animation-duration: 4s;">Read More</button> --}}
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                    {{-- <h1 class="animate__fadeInLeft" style="animation-duration: 1s;">Industry</h1>
                    <h2 class="animate__fadeInLeft" style="animation-duration: 3s;">Lorem ipsum dolor sit amet !</h2> --}}
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                    {{-- <h1 class="animate__fadeInLeft" style="animation-duration: 1s;">Alumni</h1>
                    <h2 class="animate__fadeInLeft" style="animation-duration: 3s;">Lorem ipsum dolor sit amet !</h2> --}}
...
<div class="block">
  <div class="row">
    <div class="span4">
      ...
      <div class="middle">
        <a style="text-decoration: none; color: rgb(24, 13, 13); height: 50px; font-weight: 700;" href="{{ url('/') }}/job-offer" class="btnn btn1">CLICK TO APPLY</a>
      </div>
...
{{-- <button style="font-weight: 500;" type="button" class="btn btn-outline-secondary">Read More</button> --}}
<a href="{{ url('/') }}/for-fresher" style="font-weight: 500">Learn More</a>
</div>
...
{{-- <button style="font-weight: 500;" type="button" class="btn btn-outline-secondary" href="{{ url('/') }}/for-fresher">Read More</button> --}}
<a href="{{ url('/') }}/for-fresher" style="font-weight: 500">Learn More</a>
</div>
...
{{-- <button style="font-weight: 500;" type="button" class="btn btn-outline-secondary">Read More</button> --}}
<a href="{{ url('/') }}/for-experience" style="font-weight: 500">Learn More</a>
</div>
