    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
        ...
        <div class="collapse navbar-collapse" id="collapse_target">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>/event">Events</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>/alumni-directory" class="btn btn-primary">Alumni Directory</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>/student-directory">Student Directory</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown_target">
                            <a class="dropdown-item" href="<?php echo e(url('/')); ?>/alumni-register">Alumni Signup</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<?php echo e(url('/')); ?>/student-register">Student Signup</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown_target">
                            <a class="dropdown-item" href="<?php echo e(url('/')); ?>/alumni-login">Alumni Login</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<?php echo e(url('/')); ?>/student-login">Student Login</a>
                        </div>
                    </li>
