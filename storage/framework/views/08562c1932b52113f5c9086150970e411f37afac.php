    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
        ...
        <div class="collapse navbar-collapse" id="collapse_target">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>/alumni-directory">Alumni Directory</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>/student-directory">Student Directory</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Nafiur</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>/home">Logout</a>
                    </li>
...
<?php /**PATH C:\xampp\htdocs\capstone\resources\views/layouts/stdapp.blade.php ENDPATH**/ ?>